    ...
    <div className="flex items-center justify-center  min-h-screen  shadow-lg ">
      <div className=" bg-white rounded-lg shadow-lg w-[700px] h-[420px] ">
        ...
        <div className=" justify-center items-center flex mt-10">
          <button
            className="w-[350px] h-[60px] text-xl font-medium px-4 py-3 mb-4 text-white bg-[#0098f1]   rounded-md focus:outline-none transition duration-300 ease-in-out transform hover:scale-105"
        ...
        <div className=" justify-center items-center flex mt-5">
          <button
            className="w-[350px] h-[60px] text-xl font-medium px-4 py-3 text-white bg-[#0098f1]  rounded-md focus:outline-none transition duration-300 ease-in-out transform hover:scale-105"
