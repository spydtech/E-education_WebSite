...
//           <span className="text-lg font-semibold bg-gradient-to-r from-[#00BF8F] to-[#001510] bg-clip-text text-transparent">
//             Admin Name
//           </span>
//         </div>
//         <nav className="mb-6">
...
//               <button
//                 onClick={openForm}
//                 className="block w-40 h-12 py-2 px-4 bg-[#001510] text-white rounded-md mb-2"
//               >
//                 Schedule Meeting
//               </button>
//               <a
...
//                     {meeting.title} ({meeting.fromDate} {meeting.fromTime} - {meeting.toDate} {meeting.toTime})
//                   </a>
//                 </li>
//               ))
//             ) : (
