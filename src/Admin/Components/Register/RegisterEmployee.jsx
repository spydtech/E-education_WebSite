...
const RegisterEmployee = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen md:p-4 shadow-lg">
      <div
        id="main"
        className="bg-white rounded-lg shadow-lg sm:w-80 md:w-auto lg:w-[700px] h-auto lg:h-[420px] relative"
      >
        <div className="w-auto h-[100px] bg-[#001510] rounded-t-lg flex justify-center items-center">
          <h2 className="text-2xl font-bold text-white">Register Employee</h2>
        </div>
        <div className="grid  md:grid-cols-1 lg:grid-cols-2 lg:gap-4 mx-10 my-8">
          <div className="col-span-1 md:pl-16 lg:pl-0">
            <input
              ...
              value={firstName}
              onChange={(e) => setFirstName(e.target.value)}
              className="shadow appearance-none border rounded w-[300px] h-[60px] py-2 px-3 text-[#001510] leading-tight focus:outline-none border-[#2C3E50] focus:shadow-outline mb-3"
            />
            {firstNameError && (
          ...
          <div className="col-span-1 md:pl-16 lg:pl-0">
            ...
            <input
              ...
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="shadow appearance-none border rounded hover:border-[#001510]  w-[300px] h-[60px] py-2 px-3 text-[#001510] leading-tight focus:outline-none border-[#001510] focus:shadow-outline mb-3"
            />
            {emailError && (
        ...
        <div className="flex items-center md:pb-6 justify-center">
          <button
            onClick={handleAddEmployee} 
