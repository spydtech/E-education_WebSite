    ...
    <div className="overflow-x-auto">
      <div className="flex w-[250px] rounded-lg  items-center mb-4 bg-[#f6ac14]">
        <input
          ...
          className="p-3 border w-[250px] bg-[#153243] text-[15px] text-white placeholder:text-w outline-none focus:outline-none focus:ring-0 focus:border-transparent border-none rounded-lg"
