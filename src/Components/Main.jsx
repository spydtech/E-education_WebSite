...
// import home from "../assetss/Home/unnamed.png";
...
//           <div
//             className=" mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:px-8  flex gap-3 bg-black"
            
//           >
//             <div className="bg-cover w-full h-screen" style={{ backgroundImage: `url(${home})` }}>
