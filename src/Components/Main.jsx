            ...
            <div class="sm:text-center lg:text-left">
              <h1 class="font-lora text-4xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-6xl">
                <span className="xl:inline">
                  Learn <span className="text-[#f6ac14]">without</span> limits
                  <span className="block">
                    our{" "}
                    <span className="whitespace-nowrap text-[#f6ac14]">
                      courses
                    </span>
                  </span>
                </span>
              ...
              <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div class="rounded-md shadow">
                  <Link
                    to="/pricing"
                    class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#0098f1]  md:py-4 md:text-lg md:px-10"
                  >
                    Get started
                  </Link>
                </div>
                <div class="mt-3 sm:mt-0 sm:ml-3">
                  <Link
                    to="/try-a-demo"
                    class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-[#0098f1] bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"
                  >
                    Try demo
                  </Link>
                </div>
