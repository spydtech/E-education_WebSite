        ...
        <div className="flex justify-center items-center">
          <div className="space-y-5 text-center md:text-left p-5">
            ...
            <p className="text-xl text-gray-500">
              Successfully complete all course modules to obtain a Cloud Computing with AWS Fundamentals certification, greatly enhancing career prospects and skill development.
            </p>
          </div>
        </div>
      </div>
