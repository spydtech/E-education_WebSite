...
import PowerBiKeyHighights from "./PowerBiKeyHighights";
import PowerBiCertificate from "./PowerBiCertificate";
import PowerBiCareersOutcomes from "./PowerBiCareersOutcomes";
import PowerBiAbout from "./PowerBiAbout";
import { TbPlayerTrackNextFilled } from "react-icons/tb";
import { FaBars, FaTimes } from "react-icons/fa"; // Import icons for menu toggle
import PowerBiSyallabus from "./PowerBiSyallabus";
import PowerBiIntroduction from "./PowerBiIntroduction";
  ...
  return (
    <>
      ...
      <div className="mx-5">
        ...
        {currentSection === 3 && <PowerBiAbout />}
        {currentSection === 4 && <PowerBiCertificate />}
        {currentSection === 5 && <PowerBiSyallabus />}
      </div>
    </>
  );
};
