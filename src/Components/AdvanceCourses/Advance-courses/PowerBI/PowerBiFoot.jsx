        ...
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-green-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#072ac8] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#072ac8]"> Power BI</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Learn the fundamentals of Power BI to create dynamic and interactive
          data visualizations. Our courses offer comprehensive training in Power
          BI development, from basic reports to advanced dashboards. Enhance
          your data visualization skills and build impactful data insights.
        </h2>
        <a
