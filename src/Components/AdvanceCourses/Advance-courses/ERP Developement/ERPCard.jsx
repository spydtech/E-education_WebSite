      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
         ...
         {/*} <p className="text-lg text-[#31cb00] font-semibold mt-2">
            Enhance your business management skills with our comprehensive ERP courses. Dive deep into ERP systems and gain hands-on experience. Whether novice or pro, streamline and optimize your business processes with confidence.
          </p>*/}
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            ...
            {
              href: "/erp-specialize",
              imgSrc: "https://img.freepik.com/premium-photo/2d-vector-as-financial-expert-discussing-market-trends-concept-as-vector-illustration-financi_980716-377662.jpg?ga=GA1.1.124895894.1693499002&semt=ais_hybridhttps://img.freepik.com/free-vector/business-meeting-concept-illustration_114360-1511.jpg?w=740",
