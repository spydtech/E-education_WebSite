...
function AdvancePhpKeyHighights() {
        ...
        return (
          <>
            <ul className="space-y-2 pt-4 font-normal text-[16px] list-disc pl-16  bg-gray-200 shadow-2xl">
              <p className="text-2xl font-medium text-yellow-500 py-4">
                Overview
              </p>
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:px-20  bg-gradient-to-br  to-[#9e0059] from-[#640d14]"
      >
        <div id="subdiv1" className="pt-4 font-lora">
          <div id="h1" className="">
            <p className="md:lg:w-auto w-96 font-semibold text-xl p-2 text-[#ffbc42]">
          ...
          >
            ...
            <p className="text-5xl font-bold text-[#ffbc42] inline">
            ...
            {data.map((item, index) => (
              <div
                ...
                className={`hover:text-yellow-500 p-5 text-start hover:cursor-pointer text-xl font-medium my-6 mx-4 h-16 w-80 lg:md:h-16 lg:md:w-[400px] flex items-center border-2 border-opacity-15 rounded-md overflow-hidden  transition-transform duration-300 transform hover:scale-105 ${
                  selectedItem === index
                    ? "bg-[#ffbc42]  text-white hover:text-white border-none"
                    : ""
                }`}
              >
                <p>{item.label}</p>
...
export default AdvancePhpKeyHighights;
