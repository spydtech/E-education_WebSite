      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          {/*<p className="text-lg text-[#31cb00] font-semibold mt-2">
            Elevate your skills with our in-depth blockchain courses. Learn blockchain concepts, technologies, and hands-on development. Whether beginner or advanced, create secure and decentralized applications with confidence.
          </p>*/}
        </div>
