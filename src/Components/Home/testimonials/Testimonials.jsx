...
const Testimonials = ({ data }) => {
  ...
  return (
    <div className="text-center h-[100vh] flex flex-col justify-center items-center ">
      ...
      <h1 className="text-4xl mt-2 mb-8">E-education</h1>
      ...
      <div className="flex flex-col w-[100%] items-center gap-4">
        <div className="flex justify-between mt-9 w-[150px] items-center">
          <button
            onClick={decCurrentId}
            className={
              (currentId === 0
                ? "bg-gray-700 text-white shadow-none"
                : "bg-white") +
              " h-10 w-10 flex items-center justify-center rounded-full text-lg font-bold shadow-md hover:shadow-none hover:bg-gray-700 hover:text-white"
            }
          >
            &lt;
          </button>
          <button
            onClick={incCurrentId}
            className={
              (currentId === 7
                ? "bg-gray-700 text-white shadow-none"
                : "bg-white") +
