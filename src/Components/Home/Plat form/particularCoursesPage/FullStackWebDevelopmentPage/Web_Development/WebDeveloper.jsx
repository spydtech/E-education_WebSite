  ...
  return (
    ...
    <WebDevelopmentCard />
      ...
      >
        <div
          id="1"
          className=" w-[400px] rounded-lg  h-60 relative"
        >
          <div className="bg-white p-4 rounded-lg shadow-2xl border-cyan-500 border-2">
        ...
        <div id="2" className=" rounded-lg  w-[400px] h-60 relative">
          <div className="bg-white p-4 rounded-lg shadow-2xl border-cyan-500 border-2 ">
            <img src={requirements} className="w-24 h-24 absolute left-[280px]" />
            <h2 className="text-base  font-extrabold text-violet-700  sm:text-xl lg:text-lg xl:text-3xl font-lora">
              Technical Skills
            </h2>
            <div className="">
