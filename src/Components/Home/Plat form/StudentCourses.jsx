  ...
  const courseData = [
    {
      ...
      link: "/student/fullStackWebDevelopmentArray",
    },
    {
      title: "Data Science",
...

    {
      ...
      link: "/student/cyberSecurityArray",
    },
    {
      ...
      link: "/student/ethicalHackingStudentArray",
    },
    {
    ...
    <>
      ...
      <div className="flex flex-wrap justify-center items-start gap-12">
        {courseData.map((course, index) => (
          ...
          >
            <div className="relative mx-4 -mt-12 flex justify-center items-center w-24 h-24 overflow-hidden rounded-lg bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40 bg-[#006d77]">
            ...
            <div className="p-6">
              ...
              <p className="font-sans text-base font-light">{course.description}</p>
            </div>
