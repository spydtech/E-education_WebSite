     ...
     <div className="flex flex-1 font-lora w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-indigo-600 to-blue-500 md:my-20">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            ...
            <span className="relative text-[#f9ac13]"> Database Management</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Discover essential database management practices to ensure your software operates reliably and efficiently in diverse environments. Our courses provide comprehensive knowledge to design scalable architectures, implement database security measures, and leverage advanced database services for improved performance and scalability.
        </h2>
