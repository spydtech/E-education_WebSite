    ...
    <>
      <div> 
        ...
        <div className="py-2 gap-4">
          <div className="mt-1 font-extrabold leading-10 tracking-tight text-gray-900 sm:leading-none text-md lg:text-2xl font-lora"> Front-End Development</div>
        ...
        <div className="py-2 gap-4">
          <div className="mt-1 font-extrabold leading-10 tracking-tight text-gray-900 sm:leading-none sm:text-xl lg:text-2xl font-lora"> Back-End Development:</div>
          <div className="  text-gray-600 text-base font-lora">
        ...
        <div>
          <div className="flex justify-start items-center font-lora mt-2">
            ...
            <div className="text-base  text-gray-600 md:text-lg font-lora" >Prepare for the Full Stack Web Development interview</div>
          </div>
          <div className="flex justify-start items-center font-lora mt-2">
            <div>
              <FaCaretRight />
            </div>
            <div className=" text-base  text-gray-600 md:text-lg font-lora">
