...
function CybersecurityBeginnersIntroduction() {
  ...
  return (
    <>
      <div
        id="subdiv"
        className="grid grid-cols-1 md:lg:grid-cols-2 gap-x-6 h-[600px] md:mb-20  mb-16 bg-gradient-to-r from-amber-400 to-red-500"
      >
        <div
          id="div1"
          ...
          >
            ...
            <div className="py-5">
              <p className="text-6xl font-lora text-white">
                What is
                <span className="text-white-400 inline pl-2">
                  Cybersecurity?
                </span>
              </p>
            </div>
            ...
            <div className="bg-white p-5 mb-2 overflow-hidden shadow-xl sm:rounded-lg">
              ...
              <div className="flex justify-between">
                <button
                  ...
                  className="hover:text-green-700 text-black font-bold py-2 px-4 rounded"
                >
                  Previous
                </button>
