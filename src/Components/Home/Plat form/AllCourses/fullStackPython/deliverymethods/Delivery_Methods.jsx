  ...
  return (
    <div className="mb-32">
      <div id="heading" className=" py-10 space-y-2 px-32  ">
        <h1 className="text-center font-bold text-5xl md:lg:sm:w-auto w-96 text-blue-700 font-lora">
          ...
          <div id="2" className=" relative">
            <div className=" relative" id="mainone">
              <div
                ...
                id="bgimg"
                style={{
                  backgroundImage: `url(https://media.istockphoto.com/id/1358014313/photo/group-of-elementary-students-having-computer-class-with-their-teacher-in-the-classroom.jpg?s=612x612&w=0&k=20&c=3xsykmHXFa9ejL_sP2Xxiow7zdtmKvg15UxXFfgR98Q=)`,
                }}
              >
                <div
                  className="absolute inset-0 bg-black opacity-50 rounded-lg"
          ...
          <div id="3" className=" relative">
            <div className=" relative" id="mainone">
              <div
                ...
                id="bgimg"
                style={{
                  backgroundImage: `url(https://media.istockphoto.com/id/1286909296/photo/young-man-studying-stock-photo.jpg?s=612x612&w=0&k=20&c=6-1e9xgrbtmqVQki6Hl-_9XCUAXJE0mvpvH5W_Sh6no=)`,
                }}
              >
                <div
                  className="absolute inset-0 bg-black opacity-50 rounded-lg"
