  ...
  return (
    <div className="lg:container lg:mx-auto px-4">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between px-8 lg:px-0 mt-12">
        <div className="text-center lg:text-right">
          <img
            src="https://img.freepik.com/premium-vector/word-cloud-background-concept-security-protect-technology-privacy-network-cyber-information-hacker-crime-vector-illustration_616200-4769.jpg?w=826"
            alt="learning"
