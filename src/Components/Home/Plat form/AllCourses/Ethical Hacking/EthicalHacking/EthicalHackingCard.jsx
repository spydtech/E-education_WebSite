            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-1">
                <img
                  ...
                  alt="Project 1"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-cyan-500 to-blue-500 opacity-30  transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#219ebc] group-hover:text-white pt-4">
                    Browse our extensive catalog of Ethical Hacking courses.
              ...
              <a href="/project-2">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#219ebc] group-hover:text-white pt-4">
                    ...
                    algorithms, and programming languages essential for Ethical
                    Hacking.
                  </span>
                </div>
              </a>
              ...
              <a href="/project-5">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#219ebc] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of Ethical Hacking, such as
                    penetration testing, network security, or digital forensics.
...
export default EthicalHackingCard;
