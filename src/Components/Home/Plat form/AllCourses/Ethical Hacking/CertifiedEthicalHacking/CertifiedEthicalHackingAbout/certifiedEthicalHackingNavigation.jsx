...
import CertifiedEthicalHackingCertificate from "./CertifiedEthicalHackingCertificate";
import CertifiedEthicalHackingCareersOutcomes from "./CertifiedHackingCareersOutcomes";
import CertifiedEthicalHackingAbout from "./CertifiedHackingAbout";
  ...
  return (
    <>
      ...
      <div className="mx-5">
        ...
        {currentSection === 3 && <CertifiedEthicalHackingAbout />}
        {currentSection === 4 && <CertifiedEthicalHackingCertificate />}
        {currentSection === 5 && <CertifiedEthicalHackingSyallabus />}
      </div>
    </>
  );
};

export default CertifiedEthicalHackingNavigation;
