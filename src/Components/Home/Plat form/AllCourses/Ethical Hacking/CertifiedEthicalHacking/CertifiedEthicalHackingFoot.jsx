  ...
  return (
    <div className="flex mb-10 flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] text-white">
      ...
      <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl  leading-7">
        Strengthen your defenses against cyber threats with our Ethical Hacking
        expertise. Explore comprehensive security assessments, vulnerability
        analyses, and proactive defense strategies. Protect your digital assets
        with confidence.
      </h2>
      <button
