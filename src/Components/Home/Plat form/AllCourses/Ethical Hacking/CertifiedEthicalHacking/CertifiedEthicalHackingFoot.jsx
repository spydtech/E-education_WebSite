...
const CertifiedEthicalHackingFoot = () => {
  ...
  return (
    <div className="flex mb-20 flex-1 font w-full flex-col items-center justify-center text-center px-4 py-20 bg-[#0098f1] dark:bg-gray-800">
      <h1 className="mx-auto max-w-4xl font-display text-2xl font-md tracking-normal text-white-300 dark:text-gray-300 md:text-6xl">
        ...
        <span className="relative whitespace-nowrap text-white">
          ...
          <span className="relative font-bold text-[#ffffff]"> Certified Ethical Hacking</span>
        </span>
      </h1>
      ...
      <a
        className="bg-white text-[#0098f1] rounded-xl font-medium px-10 py-3 sm:mt-10 mt-8 dark:bg-gray-800 dark:text-[#0098f1] dark:hover:bg-gray-600 transition mb-0"
        href=""
...
export default CertifiedEthicalHackingFoot;
