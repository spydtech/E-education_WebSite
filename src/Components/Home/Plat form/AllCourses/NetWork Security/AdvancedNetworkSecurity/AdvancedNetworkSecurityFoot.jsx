...
function AdvancedNetworkSecurityFoot() {
  ...
  return (
    <>
      <div className="flex flex-1 font w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-cyan-100  to-cyan-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 md:my:28">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#07beb8] dark:fill-orange-300/60"
            ...
            <span className="relative  text-[#07beb8]">
              {" "}
        ...
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Discover powerful solutions for advanced network security. Our
          analytics deliver actionable insights, optimize processes, and empower
          you to stay ahead. Revolutionize data-driven decision-making in the
          field of network security.
        </h2>
        <a
          className="bg-cyan-500 dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-cyan-700 dark:hover:bg-gray-600 transition mb-0"
          href=""
...
export default AdvancedNetworkSecurityFoot;
