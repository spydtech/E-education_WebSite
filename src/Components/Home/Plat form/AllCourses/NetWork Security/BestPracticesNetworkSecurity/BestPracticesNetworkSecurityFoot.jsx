...
function NetworkSecurityBestPracticesFoot() {
  ...
  return (
    <>
      <div className="flex flex-1 font w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-red-100 to-red-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 md:my-20">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          Strengthening Your Security Posture with &nbsp;
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#ec3400] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#ec3400]"> Network Security</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Discover essential strategies to protect your digital assets. Our
          comprehensive security solutions help you mitigate risks, defend
          against threats, and ensure compliance. Secure your network with
          confidence.
        </h2>
        <a
        ...
        {/* <NetworkSecurityScroller /> */}
      </div>
    </>
  );
}

export default NetworkSecurityBestPracticesFoot;
