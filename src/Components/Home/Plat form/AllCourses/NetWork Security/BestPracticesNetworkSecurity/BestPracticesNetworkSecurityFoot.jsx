...
function NetworkSecurityBestPracticesFoot() {
  ...
  return (
    <div className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] dark:bg-gray-800 mb-20">
      <h1 className="mx-auto max-w-4xl font-display text-2xl font-md tracking-normal text-white-300 dark:text-gray-300 md:text-4xl lg:text-5xl">
        Strengthening Your Security Posture with Best Practices in <br />
      ...
      <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl text-white-500 dark:text-gray-300 leading-7">
        Discover powerful solutions for advanced network security. Our analytics
        deliver actionable insights, optimize processes, and empower you to stay
        ahead. Revolutionize data-driven decision-making in the field of network
        security.
      </h2>
      <a
