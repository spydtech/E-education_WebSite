...
function NetworkSecurityFoot() {
  ...
  return (
    <>
      <div className="flex flex-1 font w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-green-100 to-green-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 md:my-28">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            ...
            <span className="relative text-[#f9ac13]"> Network Security</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Discover essential network security practices for safeguarding
          information. Our courses offer in-depth knowledge to protect against
          cyber threats and vulnerabilities. Enhance your skills in securing
...
export default NetworkSecurityFoot;
