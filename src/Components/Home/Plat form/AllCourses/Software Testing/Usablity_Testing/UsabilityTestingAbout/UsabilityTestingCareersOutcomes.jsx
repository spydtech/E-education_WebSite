...
function UsabilityTestingCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20  bg-gradient-to-br from-[#cca000] to-[#f5cc00]"
      >
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center bg-gray-100 border-4 border-[#00509d] border-opacity-50 rounded-md overflow-hidden  "
          >
            <div id="x">
              <p>
...
export default UsabilityTestingCareersOutcomes;
