      ...
      <section id="portfolio" className="portfolio-section py-16 px-4">
        <div className="container mx-auto">
          <div className=" mb-12">
            ...
            <p className="text-lg text-[#7400b8] font-semibold mt-2">
              Enhance your expertise with our AutomationTesting courses. Dive
              deep into methodologies and gain hands-on experience. Whether
              novice or pro, ensure your applications are robust and bug-free.
            </p>
          </div>
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a>
                <img
                  ...
                  alt="AutomationTesting Introduction"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#a96ef0] to-[#8445ae] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#7400b8] group-hover:text-white pt-4">
                    Browse our extensive catalog of AutomationTesting courses.
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a>
                <img
                  ...
                  alt="AutomationTesting Foundations"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#a96ef0] to-[#8445ae] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  <h3 className="text-lg font-medium text-txt group-hover:text-gray-dark">
                  ...
                  <span className="text-sm font-bold text-[#7400b8] group-hover:text-white pt-4">
                    ...
                    tools, and methodologies essential for AutomationTesting.
                  </span>
                </div>
              </a>
            </div>
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a>
                <img
                  ...
                  alt="AutomationTesting Projects"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#a96ef0] to-[#8445ae] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  <h3 className="text-lg font-medium text-txt group-hover:text-gray-dark">
                  ...
                  <span className="text-sm font-bold text-[#7400b8] group-hover:text-white pt-4">
                    ...
                    in Automationtesting, defect tracking, and test case
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#7400b8] group-hover:text-white pt-4">
                    ...
                    proficiency in various AutomationTesting concepts as you
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#7400b8] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of AutomationTesting, such as
...
export default AutomationTestingCard;
