...
function AutomationTestingFoot() {
        ...
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-yellow-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#7400b8] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#7400b8]"> Automation Testing</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Discover essential Automation testing practices for ensuring the
          quality and reliability of your applications. Our courses offer
          in-depth knowledge to detect and fix bugs. Enhance your skills in
          Automation testing and ensure robust applications.
        </h2>
        <a
          className="bg-violet-400 dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-violet-600 dark:hover:bg-gray-600 transition mb-0"
          href=""
          onClick={handleEnroll}
        >
          Get started
        </a>
        {/* <AutomationTestingScroller /> */}
      </div>
    </>
  );
}

export default AutomationTestingFoot;
