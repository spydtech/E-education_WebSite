...
function AutomationTestingCertificate() {
  return (
    <>
  ...
  <div className=" grid grid-cols-1 md:grid-cols-2 gap-4 p-4 justify-center items-center md:px-10 md:gap-8">
    ...
    <div className="space-y-3 text-center md:text-left">
      ...
      <p className="md:text-xl text-gray-500">
        Successfully complete all course modules to obtain an Automation Testing
...
export default AutomationTestingCertificate;
