  ...
  const softwareTestingInfo = [
    {
      ...
      imgSrc:"https://img.freepik.com/free-photo/rear-view-programmer-working-all-night-long_1098-18697.jpg?ga=GA1.2.481732087.1715859514&semt=ais_hybrid",
    ...
    },
    {
      ...
      imgSrc:"https://img.freepik.com/free-photo/modern-equipped-computer-lab_23-2149241221.jpg?ga=GA1.1.481732087.1715859514&semt=ais_hybrid",
    ...
    <div className="mx-auto h-auto w-full mb-20 px-4 md:px-10 bg-white">
      <div className="py-2 my-10">
        <p className="text-2xl text-center font-bold text-[#f6ac14]">
          Discover the   Unit Testing Program
        </p>
      </div>
...
export default AutomationTestingAbout;
