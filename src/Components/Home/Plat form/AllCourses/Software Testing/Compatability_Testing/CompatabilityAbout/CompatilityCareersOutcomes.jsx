...
function CompatabilityCareersOutcomes() {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="mb-8 lg:mb-0 lg:w-1/2">
          <div className="text-start">
            <div className="py-5">
              <p className="text-2xl font-bold text-[#f9ac13]">
            ...
            <div>
              <p className="md:text-5xl text-2xl font-bold">
                Discover What our{" "}
                <span className="text-[#f9ac13]">Learners Have Achieved</span>
              </p>
            </div>
            <div>
        ...
        <div className="lg:w-1/2 flex flex-col items-center lg:items-end">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="flex flex-col items-center p-3 cursor-pointer text-xl font-medium border-2 border-transparent hover:border-[#f9ac13] bg-white rounded-md overflow-hidden shadow-lg"
              >
                {item.icon}
                <p>{item.stat}</p>
...
export default CompatabilityCareersOutcomes;
