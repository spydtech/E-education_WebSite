...
import CompatabilityKeyHighlights from "./CompatabilityKeyHighights";
...
// import UnitTestingSyallabus from "./CompatabilitySyallabus";
import CompatabilitySyllabus from "./CompatabilitySyallabus";
  ...
  return (
    <>
      ...
      <div className=" ">
        ...
        {currentSection === 1 && <CompatabilityKeyHighlights />}
        ...
        {currentSection === 5 && <CompatabilitySyllabus />}
      </div>
    </>
  );
};
