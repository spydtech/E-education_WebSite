...
function CompatabilityCertificate() {
  return (
    <>
      <div
        id="main"
        className="grid  grid-cols-1 md:lg:grid-cols-2 pb-16  bg-gradient-to-r from-orange-700 to-red-600 mb-12"
      >
...
export default CompatabilityCertificate;
