...
const SecurityTestingCard = () => {
  const courseData = [
    ...
    },
    {
      ...
      description:
        "Start with foundational courses covering basic concepts algorithms, and programming languages essential for Security testing.",
    },
    {
      imgSrc:
    ...
    },
    {
      ...
      description:
        "Choose specialized tracks or advanced courses to delve deeper into specific areas of Security testing, such as deep learning, natural language processing, or computer vision. Customize your learning path to align with your interests and career goals.",
    },
    {
      imgSrc:
