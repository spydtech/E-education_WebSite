              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    Browse our extensive catalog of Security Testing courses.
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    tools, and methodologies essential for Security Testing.
                  </span>
                </div>
              </a>
            </div>
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    in security testing, vulnerability assessment, and
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    proficiency in various Security Testing concepts as you
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of Security Testing, such as
