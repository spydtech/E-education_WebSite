...
function UnitTestingCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20 pl-4  bg-gradient-to-br from-[#0077b6] to-[#03045e] mb-12"
      >
...
export default UnitTestingCareersOutcomes;
