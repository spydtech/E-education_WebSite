...
//               Elevate your skills with our Network Security courses. Dive deep
...
//                   alt="Project 1"
//                 />
//                 <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#0077b6] to-[#03045e] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
...
//                     protocols, and tools essential for Network Security.
//                   </span>
//                 </div>
//               </a>
//             </div>
...
//                     in network security, threat analysis, and mitigation under
...
//                     ethical hacking, cryptography, or network defense. Customize
//                     your learning path to align with your interests and career
//                     goals.
//                   </span>
//                 </div>
//               </a>
...
// export default UnitTestingCard;
      ...
      <section id="portfolio" className="portfolio-section py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#f9ac13] font-semibold mt-2">
              Elevate your skills with our Software Testing courses. Dive deep
              into testing principles and gain hands-on experience. Whether
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-1">
                <img
                  ...
                  alt="Project 1"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#FF0000] to-[#00FF00] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  <h3 className="text-lg font-medium text-txt group-hover:text-gray-dark">
                    Explore Testing Techniques
                  </h3>
                  <span className="text-sm font-bold text-[#f9ac13] group-hover:text-white pt-4">
                    Browse our extensive catalog of Software Testing courses.
                    Discover various testing techniques from manual to automated
                    testing methodologies suitable for testers at all levels.
                  </span>
                </div>
              </a>
            </div>
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-2">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  <h3 className="text-lg font-medium text-txt group-hover:text-gray-dark">
                    Enroll in Test Automation Courses
                  </h3>
                  <span className="text-sm font-bold text-[#f9ac13] group-hover:text-white pt-4">
                    Start with foundational courses covering basic concepts of
                    test automation tools and frameworks essential for
                    accelerating your testing processes.
                  </span>
                </div>
              </a>
            </div>
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-3">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#f9ac13] group-hover:text-white pt-4">
                    Apply your testing knowledge by working on hands-on projects
                    tailored to real-world scenarios. Gain practical experience
                    in software testing, test case design, and defect management
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-4">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#f9ac13] group-hover:text-white pt-4">
                    Monitor your testing progress with intuitive dashboards and
                    tracking tools. Set testing goals, track testing milestones,
                    and measure your proficiency in various testing concepts as
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-5">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#f9ac13] group-hover:text-white pt-4">
                    Choose specialized tracks or advanced courses to delve
                    deeper into specific areas of Software Testing, such as test
                    automation frameworks, performance testing, or agile testing
                    methodologies. Customize your learning path to align with
