    ...
    <>
      <div className="flex mb-10 flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] text-white">
        ...
        <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl text-white leading-7">
          Discover essential software testing practices to ensure seamless
          interaction between components. Our courses provide in-depth knowledge
          to identify integration issues, automate tests, and boost system
          reliability.
        </h2>
        <a
