...
function IntigrationCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20 pl-4 bg-gradient-to-r from-blue-600 to-blue-600 mb-12"
      >
        <div id="headings" className="grid grid-cols-1 text-start ">
          <div>
            <p className="text-[#f9ac13] text-xl font-medium">
              Career Outcomes in intigration testing Program
            </p>
          </div>
          <div className="py-5">
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center bg-gray-100 border-4 border-[#f9ac13] border-opacity-50 rounded-md overflow-hidden  "
          >
            <div id="x">
              <p>
...
export default IntigrationCareersOutcomes;
