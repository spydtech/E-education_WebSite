...
function IntegrationKeyHighlights() {
  ...
  const renderContent = () => {
    switch (selectedItem) {
      case 0:
        return (
          <ul className="space-y-2 pt-4  font-normal  pl-8 text-[16px] list-disc">
    ...
    <div className=" px-20 mb-20 bg-white">
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start justify-center">
       ...
       <div className="md:lg:pl-20  pl-0">
         <div className="pt-4">
           <p className="font-semibold  underline-offset-2  underline md:lg:xl:text-xl text-base p-2 text-[#f6ac14]">
