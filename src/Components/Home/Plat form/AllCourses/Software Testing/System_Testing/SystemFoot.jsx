...
function SystemTestingFoot() {
  const [courseName] = useState("System Testing"); // Placeholder for course name
  ...
  return (
    <>
      <div className="flex flex-1 font-lora w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-indigo-600 to-blue-500 md:mb-20">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#f9ac13] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#f9ac13]"> System Testing</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Discover essential system testing practices to ensure your software
          performs reliably and efficiently in various environments. Our courses
          offer in-depth knowledge to identify and resolve system-level issues,
          automate testing processes, and enhance software quality and
          robustness.
        </h2>
...
export default SystemTestingFoot;
