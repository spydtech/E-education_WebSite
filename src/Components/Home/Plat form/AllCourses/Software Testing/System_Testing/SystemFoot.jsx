...
function SystemTestingFoot() {
  ...
  return (
    <>
      <div className="flex flex-1 font w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-indigo-600 to-blue-500 md:mb-20">
