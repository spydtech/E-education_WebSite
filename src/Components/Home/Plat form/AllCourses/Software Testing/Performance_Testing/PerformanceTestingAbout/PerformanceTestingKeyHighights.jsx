  ...
  const renderContent = () => {
    switch (selectedItem) {
      case 0:
        return (
          <ul className="space-y-2 pt-4 font-normal text-[16px] list-disc">
            <p className="text-2xl font-medium text-[#30c5ff] py-4">Overview</p>
      ...
      case 1:
        return (
          <ul className="space-y-3 pt-4 font-normal text-[16px] list-disc">
            <p className="text-2xl font-medium text-[#30c5ff] py-4">Key Concepts</p>
      ...
      case 2:
        return (
          <ul className="space-y-3 pt-4 font-normal text-[16px] list-disc">
            <p className="text-2xl font-medium text-[#30c5ff] py-4">Applications</p>
      ...
      case 4:
        return (
          <ul className="space-y-3 pt-4 font-normal text-[16px] list-disc">
            ...
            <li>Gain insights into your social media analytics using ChatGPT</li>
          </ul>
        );
      default:
        return null;
  ...
  return (
    <div className="px-20 mb-20 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start justify-center">
        <div className="w-auto h-auto md:w-[500px] md:h-[420px] mt-10 pl-0 text-xl">
          {renderContent()}
        </div>
        <div className="lg:pl-14">
          <div className="pt-4">
            <p className="text-2xl font-bold text-[#f6ac14] inline ">What does this Course have to offer?</p>
          </div>
            ...
            {data.map((item, index) => (
              <div
                ...
                className={`p-5 text-center hover:cursor-pointer text-xl font-medium my-6 mx-4 h-16 w-[210px] flex items-center border-2 border-opacity-15 rounded-md overflow-hidden transition-transform duration-300 transform hover:scale-105 ${
                  selectedItem === index
                    ? "bg-[#30c5ff] text-white border-none"
                    : ""
                }`}
              >
