...
function PerformanceTestingCareersOutcomes() {
    ...
    <>
      ...
      >
        <div id="headings" className="grid grid-cols-1 text-start pl-4">
          <div>
            <p className="text-[#30c5ff] text-xl font-medium">
              Career Outcomes in Performance Testing Program
            </p>
          </div>
          <div className="py-5">
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center bg-gray-100 border-4 border-[#30c5ff] border-opacity-50 rounded-md overflow-hidden  "
          >
            <div id="x">
              <p>
...
export default PerformanceTestingCareersOutcomes;
