    ...
    <>
      <div className="flex mb-10 flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] text-white">
        ...
        <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl text-white leading-7">
          Explore key software testing practices to confirm your product aligns
          with business goals and user needs. Our courses offer comprehensive
          insights into validating performance, automating acceptance tests, and
