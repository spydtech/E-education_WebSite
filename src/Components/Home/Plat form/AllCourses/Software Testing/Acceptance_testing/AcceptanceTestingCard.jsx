        ...
        <div className="container mx-auto ">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#31cb00] font-semibold mt-2">
              Enhance your expertise with our Security Testing courses. Dive
              ...
              <a href="/project-1">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    Browse our extensive catalog of Acceptance Testing courses.
              ...
              <a href="/project-2">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    tools, and methodologies essential for Acceptance Testing.
                  </span>
                </div>
              </a>
            </div>
              ...
              <a href="/project-3">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    in acceptance testing, vulnerability assessment, and
                    penetration testing under the guidance of industry experts.
                  </span>
                </div>
              </a>
            </div>
              ...
              <a href="/project-4">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    proficiency in various Acceptance Testing concepts as you
              ...
              <a href="/project-5">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#31cb00] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of Acceptance Testing, such as
                    automated testing, penetration testing, or incident
                    response. Customize your learning path to align with your
