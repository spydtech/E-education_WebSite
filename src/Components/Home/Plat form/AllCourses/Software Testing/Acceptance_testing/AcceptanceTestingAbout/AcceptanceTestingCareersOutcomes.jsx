...
function AcceptanceTestingCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20  bg-gradient-to-br from-[#560bad] to-[#3a0ca3]"
      >
        <div id="headings" className="grid grid-cols-1 text-start pl-4 ">
          <div>
            <p className="text-[#31cb00] text-xl font-medium">
              Career Outcomes in Acceptance Testing Program
            </p>
          </div>
          <div className="py-5">
            <p className="md:text-5xl text-2xl font">
              Discover What our{" "}
              <p className="text-[#31cb00]">Learners Have Achieved</p>
            </p>
          </div>
          <div>
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center bg-gray-100 border-4 border-[#31cb00] border-opacity-50 rounded-md overflow-hidden  "
          >
            <div id="x">
              <p>
...
export default AcceptanceTestingCareersOutcomes;
