...
import AcceptanceTestingKeyHighights from "./AcceptanceTestingKeyHighights";
import AcceptanceTestingCertificate from "./AcceptanceTestingCertificate";
import AcceptanceTestingCareersOutcomes from "./AcceptanceTestingCareersOutcomes";
import AcceptanceTestingAbout from "./AcceptanceTestingAbout";
import { TbPlayerTrackNextFilled } from "react-icons/tb";
import { FaBars, FaTimes } from "react-icons/fa"; // Import icons for menu toggle
import AcceptanceTestingSyallabus from "./AcceptanceTestingSyallabus";
import AcceptanceTestingIntroduction from "./AcceptanceTestingIntroduction";
import { FaAngleDoubleLeft, FaAngleDoubleRight } from "react-icons/fa";
const AcceptanceTestingNavigation = () => {
  const sections = [
    "Introduction",
    "Key Highlights",
    "Career Outcomes",
  ...
  return (
    <>
      ...
      <div className="mx-5">
        {currentSection === 0 && <AcceptanceTestingIntroduction />}
        {currentSection === 1 && <AcceptanceTestingKeyHighights />}
        {currentSection === 2 && <AcceptanceTestingCareersOutcomes />}
        {currentSection === 3 && <AcceptanceTestingAbout />}
        {currentSection === 4 && <AcceptanceTestingCertificate />}
        {currentSection === 5 && <AcceptanceTestingSyallabus />}
      </div>
    </>
  );
};

export default AcceptanceTestingNavigation;
