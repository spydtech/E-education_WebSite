...
function ManualTestingCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20  bg-gradient-to-br  from-[#0077b6] to-[#00b4d8]"
      >
        <div id="headings" className="grid grid-cols-1 text-start ">
          <div>
            <p className="text-[#fca311] text-xl font-medium pl-4">
              Career Outcomes in Manual Testing Program
            </p>
          </div>
          <div className="py-5">
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center bg-gray-100 border-4 border-[#fca311] border-opacity-50 rounded-md overflow-hidden  "
          >
            <div id="x">
              <p>
...
export default ManualTestingCareersOutcomes;
