...
import StressTestingKeyHighlights from "./StressTestingKeyHighights";
import StressTestingCertificate from "./StressTestingCertificate";
import StressTestingAbout from "./StressTestingAbout";
import StressTestingCareersOutcomes from "./StressTestingCareersOutcomes";
import StressTestingSyllabus from "./StressTestingSyallabus";
import { TbPlayerTrackNextFilled } from "react-icons/tb";
import { FaBars, FaTimes } from "react-icons/fa";
// import SystemTestingIntroduction from "./StressTestingIntroduction";
import StressTestingIntroduction from "./StressTestingIntroduction";
const StressTestingNavigation = () => {
  const sections = [
    "Introduction",
    "Key Highlights",
    "Career Outcomes",
  ...
  return (
    <>
      ...
      <div className="mx-5 ">
        ...
        {currentSection === 3 && <StressTestingAbout />}
        {currentSection === 4 && <StressTestingCertificate />}
        {currentSection === 5 && <StressTestingSyllabus />}
      </div>
    </>
  );
};

export default StressTestingNavigation;
