...
function StressTestingCertificate() {
  return (
    <>
      <div
        id="main"
        className="grid  grid-cols-1 md:lg:grid-cols-2 pb-16  bg-gradient-to-r from-indigo-500 to-indigo-500  mb-12"
      >
...
export default StressTestingCertificate;
