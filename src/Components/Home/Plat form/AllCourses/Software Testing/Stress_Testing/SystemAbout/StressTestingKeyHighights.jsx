...
function StressTestingKeyHighlights() {
        ...
        return (
          <>
            <ul className="space-y-2 pt-4 font-normal text-[16px] list-disc pl-16 bg-gray-200 shadow-2xl mb-12">
              ...
              <li>Introduction to stress testing and its importance.</li>
              <li>Validating the complete and integrated software product.</li>
              <li>
                Types of stress testing: Functional, Performance, Security, and
                Usability testing.
              </li>
              <li>
                Role of stress testing in ensuring software quality and
                robustness.
              </li>
              <li>Tools and technologies used in stress testing.</li>
            </ul>
          </>
        );
      case 1:
        ...
        return (
          <>
            <ul className="space-y-3 pt-4 font-normal text-[16px] list-disc pl-16 bg-gray-200 shadow-2xl">
              ...
              <li>
                Software Developers looking to enhance stress testing skills.
              </li>
              ...
              <li>
                Project managers aiming to understand stress testing processes
                better.
              </li>
              <li>
  ...
  return (
    <>
      <div
        id="main"
        className="md:lg:xl:px-20 bg-gradient-to-r from-indigo-500 to-indigo-500 mb-12"
      >
        <div id="subdiv1" className="pt-4">
          <div id="h1" className="">
            <p className="md:lg:w-auto w-96 font-semibold text-xl p-2 text-[#f9ac13] pl-4">
              Stress Testing Course Highlights
            </p>
          </div>
          <div
            id="h2"
