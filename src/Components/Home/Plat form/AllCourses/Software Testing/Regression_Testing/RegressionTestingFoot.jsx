        ...
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-yellow-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#00a8e8] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#00a8e8]"> Regression Testing</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          Gain deep insights into regression testing to ensure your applications
          remain functional and stable after every update. Our courses provide
          the knowledge you need to effectively implement regression testing
...
export default RegressionTestingFoot;
