...
function RegressionTestingCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20  bg-gradient-to-br from-[#6f1d1b] to-[#432818]"
      >
        <div id="headings" className="grid grid-cols-1 text-start ">
          <div>
            <p className="text-[#00a8e8] text-xl font-medium pl-4">
              Career Outcomes in Regression Testing Program
            </p>
          </div>
          <div className="py-5">
            <p className="md:text-5xl text-2xl font pl-4">
              Discover What our{" "}
              <p className="text-[#00a8e8]">Learners Have Achieved</p>
            </p>
          </div>
          <div>
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center bg-gray-100 border-4 border-[#00a8e8] border-opacity-50 rounded-md overflow-hidden  "
          >
            <div id="x">
              <p>
