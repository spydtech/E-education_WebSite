...
function RegressionTestingKeyHighights() {
    ...
    <>
      ...
      >
        <div id="subdiv1" className="pt-4 font-lora">
          <div id="h1" className="">
            <p className="md:lg:w-auto w-96 font-semibold text-xl p-2 text-[#00a8e8]">
          ...
          >
            ...
            <p className="text-5xl font-bold text-[#00a8e8] inline">
            ...
            {data.map((item, index) => (
              <div
                ...
                className={`hover:text-sky-500 p-5 text-start hover:cursor-pointer text-xl font-medium my-6 mx-4 h-16 w-80 lg:md:h-16 lg:md:w-[400px] flex items-center border-2 border-opacity-15 rounded-md overflow-hidden  transition-transform duration-300 transform hover:scale-105 ${
                  selectedItem === index
                    ? "bg-[#00a8e8]  text-white hover:text-white border-none"
                    : ""
                }`}
              >
                <p>{item.label}</p>
...
export default RegressionTestingKeyHighights;
