    ...
    <div className=" px-20 mb-20 bg-white">
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start justify-center">
       ...
       <div className="  md:lg:pl-20  pl-0">
         <div className="pt-4">
           <p className=" sm:font-normal font-semibold  underline-offset-2  underline md:lg:xl:text-2xl  pb-4 text-[#f6ac14]">
         ...
         {data.map((item, index) => (
           <div
             ...
             className={`p-6 text-center  hover:cursor-pointer text-xl font-medium my-6  h-16 w-[210px] flex justify-center items-center border-2 border-opacity-15 rounded-md overflow-hidden transition-transform duration-300 transform hover:scale-105 ${
               selectedItem === index
