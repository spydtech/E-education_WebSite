...
function CybersecurityCertificate() {
  return (
    <div
      id="main"
      className="grid grid-cols-1 md:grid-cols-2 pb-16 mb-16 bg-gradient-to-br from-purple-400 via-pink-500 to-red-600"
    >
...
export default CybersecurityCertificate;
