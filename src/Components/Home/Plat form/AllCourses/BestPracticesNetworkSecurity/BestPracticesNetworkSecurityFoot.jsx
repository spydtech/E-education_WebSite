...
function NetworkSecurityBestPracticesFoot() {
  return (
    <>
      <div className="flex flex-1 font-lora w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-red-100 to-red-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
