  ...
  return (
    <div className="mb-32">
      <div id="heading" className=" py-10 space-y-2 px-32  ">
        <h1 className="text-center font-bold text-5xl md:lg:sm:w-auto w-96 text-[#25a244]  font-lora">
          Our Available Delivery Methods
        </h1>
        <h1 className=" flex justify-center md:lg:sm:w-auto w-96 text-[#25a244] ">
        ...
        >
          <div id="1" className=" relative">
            <div className=" relative" id="mainone">
              ...
              >
                ...
                <Link>
                  <p className="font-medium pt-2  hover:text-white bg-green-400 hover:bg-green-800 rounded p-2">
                    Enquire Now
                  </p>
                </Link>
              </div>
          ...
          <div id="2" className=" relative">
            <div className=" relative" id="mainone">
              ...
              >
                ...
                <Link>
                  <p className="font-medium pt-2  bg-green-400 hover:bg-green-800 hover:text-white rounded p-2">
                    Enquire Now
                  </p>
                </Link>
              </div>
          ...
          <div id="4" className=" relative">
            <div className=" relative" id="mainone">
              ...
              <div
                className="bg-white px-3 rounded-lg flex justify-center items-center md:flex-row  gap-4 shadow-2xl absolute text-black -bottom-11 left-4 z-10 w-[280px] h-24"
                id="card"
              >
                ...
                <Link>
                  <div className="font-medium  bg-green-400 hover:bg-green-800 hover:text-white  rounded p-2">
                    Enquire Now
                  </div>
                </Link>
                {/* </div> */}
