...
function DataScienceFoot() {
  ...
  return (
    <>
      <div className="flex flex-1 font-lora w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-pink-200 to-pink-200 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#ff206e] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#ff206e]"> Data Science</span>
          </span>
        </h1>
        ...
        <a
          className="bg-pink-500 dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-pink-700 dark:hover:bg-gray-600 transition mb-0"
          href=""
...
export default DataScienceFoot;
