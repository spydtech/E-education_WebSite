        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold">
              Mastering Data Science: Transform Your Skills
            </h2>
            <p className="text-lg text-[#ff206e] font-semibold mt-2">
              Elevate your skills with our Data Science courses. Dive deep into
              principles and gain hands-on experience. Whether novice or pro,
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a>
                <img
                  ...
                  alt="Project 1"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#f72585] to-[#f15bb5] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#ff206e] group-hover:text-white pt-4">
                    Browse our extensive catalog of Data Science courses.
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#ff206e] group-hover:text-white pt-4">
                    ...
                    algorithms, and tools essential for Data Science.
                  </span>
                </div>
              </a>
            </div>
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#ff206e] group-hover:text-white pt-4">
                    ...
                    proficiency in various Data Science concepts as you advance
                    through the courses.
                  </span>
                </div>
              </a>
              ...
              <a>
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#ff206e] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of Data Science, such as data
                    engineering, predictive analytics, or machine learning.
