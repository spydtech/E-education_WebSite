...
function DataScienceKeyHighights() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:px-20  bg-gradient-to-br from-[#4e148c] to-[#613dc1]"
      >
        <div id="subdiv1" className="pt-4 font-lora">
          <div id="h1" className="">
            <p className="md:lg:w-auto w-96 font-semibold text-xl p-2 text-[#ff206e]">
          ...
          >
            ...
            <p className="md:text-5xl text-2xl font-bold text-[#ff206e] inline">
          ...
          <div id="content1" className="">
            {data.map((item, index) => (
              <div
                ...
                className={`hover:text-pink-700 p-5 text-start hover:cursor-pointer text-xl font-medium my-6 mx-4 h-16 w-80 lg:md:h-16 lg:md:w-[400px] flex items-center border-2 border-opacity-15 rounded-md overflow-hidden transition-transform duration-300 transform hover:scale-105 ${
                  selectedItem === index
                    ? "bg-[#ff206e]  text-white hover:text-white border-none"
                    : ""
                }`}
              >
                <p>{item.label}</p>
...
export default DataScienceKeyHighights;
