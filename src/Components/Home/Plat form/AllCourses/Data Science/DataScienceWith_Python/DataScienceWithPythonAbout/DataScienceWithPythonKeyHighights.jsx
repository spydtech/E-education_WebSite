...
function DataScienceWithPythonKeyHighights() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:px-20  bg-gradient-to-br from-[#38b000] to-[#70e000]"
      >
        <div id="subdiv1" className="pt-4">
          <div id="h1" className="">
            <p className="md:lg:w-auto w-96 font-semibold text-xl p-2 text-[#750e5c]">
          ...
          >
            ...
            <p className="md:text-5xl text-2xl font-bold text-[#750e5c] inline">
          ...
          <div id="content1" className="">
            {data.map((item, index) => (
              <div
                ...
                className={`hover:text-pink-800 p-5 text-start hover:cursor-pointer text-xl font-medium my-6 mx-4 h-16 w-80 lg:md:h-16 lg:md:w-[400px] flex items-center border-2 border-opacity-15 rounded-md overflow-hidden  transition-transform duration-300 transform hover:scale-105 ${
                  selectedItem === index
                    ? "bg-[#750e5c]  text-white hover:text-white border-none"
                    : ""
                }`}
              >
                <p>{item.label}</p>
...
export default DataScienceWithPythonKeyHighights;
