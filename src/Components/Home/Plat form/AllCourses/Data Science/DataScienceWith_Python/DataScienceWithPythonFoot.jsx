    ...
    <>
      <div className="flex mb-10 flex-1 w-full flex-col items-center justify-center text-center px-4 py-10 bg-[#0098f1] text-white">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-md tracking-normal  md:text-4xl lg:text-5xl">
          Master the Art of Data Science through the Expertise of
          <span className="relative whitespace-nowrap text-white">
            ...
            <span className="relative font-bold text-[#ffffff]"> Python</span>
          </span>
        </h1>
        <h2 className="mt-5 md:mt-10 max-w-xl text-lg lg:text-xl  leading-7">
          ...
          derive insights from data. Unlock new possibilities by turning data
