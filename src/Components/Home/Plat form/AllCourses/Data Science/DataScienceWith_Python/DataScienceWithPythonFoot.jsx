        ...
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-gray-800 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#750e5c] dark:fill-orange-300/60"
            ...
            <span className="relative text-[#750e5c]">
              {" "}
              Data Science with Python
            </span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg text-gray-800 dark:text-gray-300 leading-7">
          Discover powerful data science solutions for businesses. Our analytics
...
export default DataScienceWithPythonFoot;
