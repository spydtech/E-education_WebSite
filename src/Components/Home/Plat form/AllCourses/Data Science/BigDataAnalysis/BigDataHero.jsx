...
const BigDataHero = () => {
  ...
  return (
    <div className="relative w-full h-[480px] bg-cover bg-center" style={{ backgroundImage: 'url("https://res.cloudinary.com/ds5ooz2ve/image/upload/v1725874356/image_13_oi7qfs.png")' }}>
    <div className="absolute inset-0 flex items-center justify-center">
      ...
      {/* Empowering you to leverage massive data sets and extract valuable 
            ...
            Unlock the Power of Big Data! In this course, you'll learn to transform complex datasets into actionable insights using tools like Python, R, Hadoop, and Spark. Develop essential skills to excel in data-driven industries and prepare for exciting career opportunities!
      </p>
    </div>
