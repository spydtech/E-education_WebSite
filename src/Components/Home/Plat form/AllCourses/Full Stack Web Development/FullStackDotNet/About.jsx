...
const About = () => {
  return (
    <>
      ...
      <div className="fone-bold sm:text-xl text-xl md:text-4xl lg:text-5xl text-[#0098F1] font-bold">About this Course</div>
        ...
        <div className="py-2 gap-4 pb-8 ">
          ...
          <div className="  text-[#0098F1] text-base font">
            <span className="mt-3   text-[#F6AC14] text-lg sm:mt-5 font-medium">ASP.NET Core:
            </span>{" "}
          ...
          <div className="  text-[#0098F1] text-base font">
            <span className="mt-3 text-xl font-lg text-[#F6AC14] sm:mt-5 font-medium ">
            JavaScript:
            </span>{" "}
        ...
        <div className="py-2 gap-4 pb-8 ">
          ...
          <div className="  text-[#0098F1] text-base font">
            <span className="mt-3 text-xl  text-[#F6AC14] sm:mt-5 font-medium font">
            .NET Core:
            </span>{" "}
            ...
            <div className="  text-[#0098F1] lg:text-lg font"> <span className="mt-3  text-xl text-[#F6AC14] sm:mt-5  font-medium">
             Entity Framework:
             </span>{" "}
        ...
        <div>
          <div className="flex justify-start items-center font mt-2">
            ...
            <div className="text-base  text-[#0098F1] md:text-lg font" > Master the skills needed for .NET Full Stack Development.</div>
          </div>
          <div className="flex justify-start items-center font mt-2">
            <div>
            <MdOutlineKeyboardDoubleArrowRight className="text-3xl font-bold text-[#F6AC14]" />
