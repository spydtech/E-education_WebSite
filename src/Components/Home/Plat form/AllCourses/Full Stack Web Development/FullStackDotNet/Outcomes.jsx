          ...
          <div className="pl-4">
            <div className="flex justify-start items-center gap-2 mt-2">
              ...
              <div className="text-base text-gray-600 text-md font-lora">
                Acquire .NET Full Stack skills. Industry-recognized
            ...
            <div className="flex justify-start items-center gap-2 mt-2">
              ...
              <div className="text-base text-gray-600 text-md font-lora">
                Master .NET Full Stack technologies with real-world projects.
            ...
            <div className="flex justify-start items-center gap-2 mt-2">
              ...
              <div className="text-base text-gray-600 text-md font-lora">
                Elevate career with .NET Full Stack. Industry-endorsed. Prepare
                for success.
              </div>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 lg:w-2/3 xl:w-1/2 order-1 md:order-2">
          ...
          <div className="pl-16">
            <div className="flex justify-start items-center gap-2 mt-2">
              ...
              <div className="text-base text-gray-600 text-md font-lora">
                Acquire comprehensive .NET Full Stack skills for industry
                recognition.
              </div>
            </div>
            <div className="flex justify-start items-center gap-2 mt-2">
              ...
              <div className="text-base text-gray-600 text-md font-lora">
                Excel in .NET Full Stack development with real-world projects.
              </div>
            </div>
            <div className="flex justify-start items-center gap-2 mt-2">
              <div>
          ...
          <div className="pl-4">
            <div className="flex justify-start items-center gap-2 mt-2">
              ...
              <div className="text-base text-gray-600 font-lora">
                Master both front-end and back-end technologies with .NET Full
                Stack for diverse job roles.
              </div>
            </div>
            <div className="flex justify-start items-center gap-2 mt-2">
              <div>
