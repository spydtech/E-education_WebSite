      ...
      <div className="max-w-screen-xl px-4 mx-auto mt-8 sm:mt-12 sm:px-6 md:mt-16">
        <div className="  lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left pl-4 mb-8">
            ...
            <h2 className="mt-1   leading-10 tracking-tight text-gray-900 sm:leading-none text-xl md:text-4xl lg:text-5xl font-bold font">
            ...
            Transform your web development skills with our comprehensive
              ...
              with React, we equip you with the latest tools and technologies to
              create seamless and scalable applications.
            </p>
