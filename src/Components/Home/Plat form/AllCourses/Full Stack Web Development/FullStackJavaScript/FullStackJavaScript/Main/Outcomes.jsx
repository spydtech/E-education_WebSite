  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:space-x-4 mt-8">
        ...
        <div className="w-full md:w-1/2">
          <img
            src="https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://images.ctfassets.net/wp1lcwdav1p1/4CrH1dP7NxqJsZaU2LQii8/39914091a0d536ac77e2b4564a9c80b2/iStock-973715860_2.jpg?w=1500&h=680&q=60&fit=fill&f=faces&fm=jpg&fl=progressive&auto=format%2Ccompress&dpr=1&w=1000"
            className="rounded-xl w-full max-w-md mx-auto"
            alt="Home office"
          />
        </div>
