...
const JavascriptDevelopment = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="w-full bg-radial-gradient bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500 md:pl-28 py-12 grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-8 max-w-8xl mx-auto">
        <div className="font-l">
          ...
          <button className="bg-indigo-600 text-white font-medium py-2 px-4 rounded transition-all hover:bg-indigo-700 active:scale-95">
            Enroll Now
          </button>
