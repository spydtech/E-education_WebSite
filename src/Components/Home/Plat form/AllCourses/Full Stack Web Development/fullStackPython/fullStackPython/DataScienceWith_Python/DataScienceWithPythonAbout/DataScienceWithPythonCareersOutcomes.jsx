...
function DataScienceWithPythonCareersOutcomes() {
  ...
  return (
    <>
      <div
        id="main"
        className=" md:lg:xl:pl-20  bg-gradient-to-br from-[#38b000] to-[#70e000]"
      >
        <div id="headings" className="grid grid-cols-1 text-start ">
          <div>
            <p className="text-[#750e5c] text-xl font-medium">
              Career Outcomes in Data Science With Python Program
            </p>
          </div>
          <div className="py-5">
            <p className="text-6xl font-lora">
              Discover What our{" "}
              <p className="text-[#750e5c]">Learners Have Achieved</p>
            </p>
          </div>
          <div>
        ...
        <div id="subdiv" className="grid grid-cols-1 md:grid-cols-2 gap-x-6 ">
          <div
            id="a"
            className="grid grid-rows-2 grid-cols-2 gap-8 p-3  hover:cursor-pointer text-xl font-medium my-6 items-center border-4 bg-gray-100 border-[#750e5c] border-opacity-50 rounded-md overflow-hidden shadow-lg "
          >
            <div id="x">
              <p>
...
export default DataScienceWithPythonCareersOutcomes;
