        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold ">
              Mastering Big Data Analysis: Transform Your Skills
            </h2>
            <p className="text-lg text-[#38b000] font-semibold mt-2">
              Elevate your skills with our Big Data Analysis courses. Dive deep
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-1">
                <img
                  ...
                  alt="Project 1"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r from-[#0081a7] to-[#00afb9] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#38b000] group-hover:text-white pt-4">
                    Browse our extensive catalog of Big Data Analysis courses.
              ...
              <a href="/project-4">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#38b000] group-hover:text-white pt-4">
                    ...
                    proficiency in various Big Data Analysis concepts as you
              ...
              <a href="/project-5">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#38b000] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of Big Data Analysis, such as
                    data engineering, predictive analytics, or big data
                    technologies. Customize your learning path to align with
