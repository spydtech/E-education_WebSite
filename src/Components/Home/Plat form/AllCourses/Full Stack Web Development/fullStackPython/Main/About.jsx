    ...
    <>
      <div className="px-2 md:px-5">
        ...
        <div className="my-3 md:text-lg">
          ...
          <p className="  text-[#0098F1] my-2">
            <span className=" text-[#F6AC14] font-semibold">React:</span>{" "}
        ...
        <div className="my-3 md:text-lg ">
          ...
          <p className="  text-[#0098F1] my-2">
            <span className=" text-[#F6AC14] font-semibold">Python:</span>{" "}
          ...
          <p className="  text-[#0098F1] my-2">
            <span className=" text-[#F6AC14] font-semibold">Django/Flask:</span>{" "}
