...
<div className="max-w-screen  px-4 mx-auto  sm:px-6 mb-12 ">
        <div className="  lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          <div className="sm:text-center pt-6 md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left pl-4 mb-8">
            ...
            <h2 className="mt-1    tracking-tight text-gray-900 sm:leading-none sm:text-xl text-xl md:text-3xl lg:text-4xl font-bold font">
              Next-Gen <span className="text-[#F6AC14]">   Full Stack</span>  Python Development
            </h2>
