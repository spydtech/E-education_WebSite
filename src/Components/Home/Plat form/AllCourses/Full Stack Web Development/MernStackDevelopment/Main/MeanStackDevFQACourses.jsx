...
const data = [
    {
      ...
      description: "Learn the essentials of Angular for building dynamic user interfaces.Explore TypeScript and how it integrates with Angular for robust development.Implement responsive design principles to ensure your applications look great on any device.",
        
    },
    {
      id: 2,
      title: "JavaScript Programming with Node.js",
      description: "Master the fundamentals of JavaScript programming.Delve into server-side development using Node.js Learn to build scalable network applications using Node.js and Express.",
      
    },
    {
      id: 3,
      title: "Database Management with MongoDB",
      description: "Get introduced to NoSQL databases with MongoDB.Learn to design and manage databases using MongoDB.Explore data modeling, schema design, and CRUD operations in MongoDB.",
