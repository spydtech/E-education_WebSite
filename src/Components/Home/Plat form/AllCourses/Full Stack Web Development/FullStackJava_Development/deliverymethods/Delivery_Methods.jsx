  ...
  return (
    <div className="mb-32">
      <div id="heading" className=" py-10 space-y-2 lg:px-32  ">
        <h1 className="text-center font-bold text-5xl md:lg:sm:w-auto w-auto text-[#f3a916]  font-lora">
          Our Available Delivery Methods
        </h1>
        <h1 className=" flex justify-center md:lg:sm:w-auto w-auto text-[#f3a916] ">
          <IoRemoveOutline className="text-[40px]" />
          <IoReorderThreeOutline className="text-[40px]" />{" "}
          <IoRemoveOutline className="text-[40px]" />
        </h1>
        <p className="text-center text-xl md:lg:sm:w-auto lg:w-auto font-lora">
      ...
      <div className="flex md:flex-row justify-center items-center gap-24">
        <div
          id="submain"
          className="grid  gap-8 gap-y-24 lg:gap-x-24  lg:grid-cols-4  md:grid-cols-2 md:lg:sm:px-0  grid-cols-1  lg:md:xl:gap-16 md:mx-20 items-center justify-center"
        >
