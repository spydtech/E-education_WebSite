...
const About = () => {
  return (
    <>
<<<<<<< HEAD:src/Components/Home/Plat form/AllCourses/Full Stack Web Development/FullStackWebDevelopmentPage/FullStackWebDevelopmentPage/About.jsx
      <div>
        <h1 className="text-[#0098F1] font-semibold text-[25px]">
          About this course
        </h1>

        <div className="pt-4 w-full font-sans text-[#0098F1]">
=======
      <div> 
      <div className="fone-bold md:text-5xl font text-2xl font-bold">About this Course</div>
        <div className="pt-4 w-full font">
>>>>>>> 972d127265d9cb78e023f51cfba46c7a49df5c0d:src/Components/Home/Plat form/AllCourses/Full Stack Web Development/FullStackWebDevelopmentPage/About.jsx
...
<<<<<<< HEAD:src/Components/Home/Plat form/AllCourses/Full Stack Web Development/FullStackWebDevelopmentPage/FullStackWebDevelopmentPage/About.jsx
          <div className="mt-1 text-[#0098F1] font-semibold text-[25px] leading-10 tracking-tight  sm:leading-none text-md lg:text-2xl ">
            {" "}
            Front-End Development
          </div>
          <div className=" text-[#0098F1] text-base font-lora">
            <span className="mt-3 text-base  text-[#F6AC14] font-bold  sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-lora">
              HTML/CSS:
            </span>{" "}
            Proficiency in at least one back-end programming language such as
            JavaScript (Node.js), Python (Django or Flask), Ruby (Ruby on
            Rails), or Java (Spring Boot).
          </div>
          <div className=" text-[#0098F1] text-base font-lora">
            <span className="mt-3 text-base font-bold text-[#F6AC14] sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-lora">
              JavaScript:
            </span>{" "}
            A deep understanding of JavaScript is crucial for creating
            interactive and dynamic web experiences. This includes modern
          ...
          <div className="  text-[#0098F1] text-base font-lora">
            ...
            Ability to create websites that adapt and look good on various
            devices and screen sizes
          </div>
        </div>
        <div className="py-2 gap-4">
          <div className="mt-1   text-[#0098F1] font-semibold text-[25px]leading-10 tracking-tight  sm:leading-none sm:text-xl lg:text-2xl ">
            {" "}
            Back-End Development:
          </div>
          <div className=" text-[#0098F1] text-base font-lora">
            <span className="mt-3 font-bold text-base text-[#F6AC14] sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-lora">
            ...
            <div className="  text-[#0098F1] text-base font-lora">
              ...
              or SQLite, and how to interact with them using SQL or NoSQL
              queries.
            </div>{" "}
          </div>
          <div className="  text-[#0098F1] text-base font-lora">
...
<<<<<<< HEAD:src/Components/Home/Plat form/AllCourses/Full Stack Web Development/FullStackWebDevelopmentPage/FullStackWebDevelopmentPage/About.jsx
        <div className="mt-3 font-semibold text-[#0098F1] sm:mt-5 sm:text-xl lg:text-lg xl:text-xl ">
          What you'll learn
        </div>
=======
...
>>>>>>> 972d127265d9cb78e023f51cfba46c7a49df5c0d:src/Components/Home/Plat form/AllCourses/Full Stack Web Development/FullStackWebDevelopmentPage/About.jsx
        <div>
          <div className="flex justify-start items-center font mt-2">
            <div>
              <FaAnglesRight className="text-[#F6AC14]" />
            </div>
            <div className="text-base text-[#0098F1] md:text-lg font-lora">
