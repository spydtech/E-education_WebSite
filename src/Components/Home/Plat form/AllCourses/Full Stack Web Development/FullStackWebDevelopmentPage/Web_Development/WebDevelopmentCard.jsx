          ...
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left pl-4 mb-8">
            ...
            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow font">
                <a
                  href="/"
                  className="flex items-center justify-center w-full px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-[#0098F1] border border-transparent rounded-md hover:bg-[#0098F1] focus:outline-none focus:shadow-outline md:py-4 md:text-lg md:px-10"
                >
                  Explore Now
                </a>
              </div>
