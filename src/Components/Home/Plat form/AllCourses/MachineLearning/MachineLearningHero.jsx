...
import MachineLearningScroller from './MachineLearningScroller'
...
>
  ...
  <span className="block w-full">Unlock the Power of Machine Learning</span> for
  optimizing your business!
</h1>
<p className="py-4 text-lg text-gray-500 2xl:py-8 md:py-6 2xl:pr-5">
  Empowering you to leverage advanced algorithms and data insights, we are your trusted partners in driving business success...
</p>
...
<div className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
  ...
  Transforming Insurance &nbsp;
    ...
    <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
      ...
      <span className="relative  text-[#f18701]"> Machine Learning</span>
    </span>
  </h1>
  <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
    Discover powerful machine learning solutions for businesses. Our algorithms deliver actionable insights, optimize processes, and empower you to stay ahead. Revolutionize data-driven decision-making.
  </h2>
  <a
    className="bg-orange-600 dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-orange-500 dark:hover:bg-gray-600 transition mb-0"
    href=""
  >
    Get started
  </a>
  <MachineLearningScroller />
</div>
