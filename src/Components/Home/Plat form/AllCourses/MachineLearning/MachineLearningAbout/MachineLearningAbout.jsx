...
const MachineLearningAbout = () => {
  return (
    <div className=" mx-auto w-full pl-20 p-1 bg-gradient-to-br from-yellow-300 via-orange-500 to-red-600">
      <div className="pt-0">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700">
                ...
                through the "ask us?" option on our learning platform for
                urgent queries.
              </p>
            </div>
          </div>
