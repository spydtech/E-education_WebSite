        ...
        {wishlist.map((course) => (
          ...
          >
            <div className="text-white relative">
              ...
              <button
                id="cartbutton"
                className="relative left-60 bottom-6"
                onClick={() => handledataTransfer(course)}
              >
                <FaCartArrowDown className="w-8  top-3  right-3 absolute rounded h-8 transition-transform duration-300 transform hover:scale-125 text-green-600" />
              </button>
              <button
                id="deletebutton"
                className="relative left-60 bottom-6"
              ...
              >
                <IoTrashBinOutline className="w-8  top-3 left-3 absolute rounded h-8 transition-transform duration-300 transform hover:scale-125 text-red-600" />
              </button>
            </div>
