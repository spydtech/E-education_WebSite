...
const LeftSide = () => {
  return (
    <div className='absolute top-[32px] left-[8px] border border-blue-500 w-[270px] h-[271px] bg-[#0098F1] rounded-md'>
    <div className=' flex flex-col items-center justify-center w-full h-full'>
      <img src={mans} alt='Profile' className='h-[80px] w-[80px] rounded-full mb-2 border-4 border-white ' />
