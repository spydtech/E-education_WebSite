...
const ReactJsHero = () => {
  ...
  return (
    <>
      <div className="flex  px-6 md:px-20  items-center justify-center bg-white md:h-screen overflow-hidden">
        <div className="flex flex-col-reverse mx-2  gap-6 md:flex-row items-center max-w-8xl">
          <div className="w-full md:w-1/2 ">
            ...
            <h3 className="mt-6 mx-2 md:mt-10 text-md lg:text-xl text-center md:text-left  ">
            ...
            <div className="mt-10 mx-2 flex flex-col sm:flex-row justify-center md:justify-start">
              <button
                ...
                className="w-full sm:w-40 px-4 py-4 rounded font-semibold text-lg bg-[#0098f1] text-white "
              >
                Get started
              </button>
            </div>
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <FaReact className="md:w-[400px] md:h-[400px] w-80 h-80 animate-spin-slow text-[#0098f1]" />
          </div>
        </div>
      </div>
    </>
