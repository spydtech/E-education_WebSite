...
const ReactjsCard = () => {
  return (
    <>
    <div>
    <div id="heading" className=" py-10  px-32  ">
        <h1 className="text-center font-bold text-4xl md:lg:sm:w-auto w-96 text-violet-800 font-lora">
        ...
        <p className="text-center text-lg md:lg:sm:w-full w-[400px] font-lora">
        ReactJS: Transforming Web Development. With its declarative and component-based structure, ReactJS simplifies UI creation, ensuring high performance. Ideal for all developers, it enables the crafting of responsive, scalable, and maintainable web apps effortlessly. Explore ReactJS for dynamic web development today!
        </p>
      </div>
    </div>
  ...
  <div className="grid gap-14 md:grid-cols-3 md:gap-5">
    <div className="rounded-xl bg-gray-800 p-6 text-center shadow-xl">
      <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-teal-400 shadow-lg shadow-teal-500/40">
        <svg viewBox="0 0 33 46" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white animate-bounce">
      ...
      <h1 className="text-white mb-3 text-xl font-medium lg:px-14">Master JavaScript Basics</h1>
      <p className="px-4 text-white">Before diving into ReactJS, solidify your understanding of JavaScript fundamentals. Learn about variables, data types, functions, and control flow to build a strong foundation for React development.</p>
    </div>
    <div data-aos-delay="150" className="rounded-xl bg-gray-800 p-6 text-center shadow-xl">
      <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-rose-500 shadow-rose-500/40">
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white animate-bounce">
      ...
      <h1 className="text-white mb-3 text-xl font-medium lg:px-14 ">Dive into JSX Syntax</h1>
      <p className="px-4 text-white">Explore JSX, the syntax extension used by React for creating UI components. Familiarize yourself with JSX syntax, which blends HTML-like tags with JavaScript expressions, enabling seamless component rendering in React</p>
    </div>
    <div data-aos-delay="300" className="rounded-xl bg-gray-800 p-6 text-center shadow-xl">
      <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-sky-500 shadow-sky-500/40">
        <svg viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white animate-bounce">
      ...
      <h1 className="text-white mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Understand React Core Concepts</h1>
      <p className="px-4 text-white">Delve into React's core principles, including components, state management, and props. Gain a deep understanding of how React manages UI state and data flow, laying the groundwork for building dynamic and interactive web applications!</p>
    </div>
  </div>
</div>
