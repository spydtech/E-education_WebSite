...
const Navbar = () => {
  ...
  return (
    // <Disclosure as="nav" className="top-0 z-50 bg-white">
    //   {({ open }) => (
    //     <>
    //       <div className=" sticky mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 font-bold">
                  ...
                  {auth.user && auth.user.firstName ? (
                    <>
                      ...
                      <div className="relative inline-block">
                        ...
                        {navigationMenuOpen &&
                          navigationMenu === "getting-started" && (
                            <div className="absolute z-10 mt-1 w-48 -ml-20 rounded-md shadow-lg bg-gray-100 ring-1 ring-black ring-opacity-5 focus:outline-none">
                              <a
                                href="/MyCourse"
                                className="block mr-4 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                              >
