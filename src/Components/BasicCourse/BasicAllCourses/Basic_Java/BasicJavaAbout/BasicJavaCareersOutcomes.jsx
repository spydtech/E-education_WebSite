          ...
          <div className="text-start">
            ...
            <div className="py-5">
              <p className="text-5xl font-bold">
                Discover What our{" "}
                <span className="text-[#f6ac14] text-4xl">Learners Have Achieved</span>
              </p>
            </div>
            <div>
        ...
        <div className="lg:w-1/2 flex flex-col items-center lg:items-end">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="flex flex-col items-center p-3 cursor-pointer text-xl font-medium border-2 border-transparent hover:border-[#d90429] bg-white rounded-md overflow-hidden shadow-lg"
              >
                {item.icon}
                <p>{item.stat}</p>
