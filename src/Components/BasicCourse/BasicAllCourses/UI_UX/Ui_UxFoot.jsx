    ...
    <>
      <div className="md:my-16 flex flex-1 font w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-blue-100 to-blue-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
        <h1 className="mx-auto max-w-4xl font-display text-2xl font-bold tracking-normal text-white-300 dark:text-gray-300 md:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-green-500 dark:text-orange-300">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#0070f3] dark:fill-blue-300/60"
            ...
            <span className="relative text-[#0070f3]"> UI/UX Design</span>
          </span>
        </h1>
        <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
          ...
          advanced techniques. Unlock your creativity and build the future of
