      ...
      >
        <div id="subdiv1" className="pt-4 font">
          ...
          >
            ...
            <p className="text-5xl font-bold text-[#25a244] inline">
          ...
          <div id="content1" className="">
            {data.map((item, index) => (
              <div
                ...
                className={`hover:text-green-500 text-white p-5 text-start hover:cursor-pointer text-xl font-medium my-6 mx-4 h-16 w-80 lg:md:h-16 lg:md:w-[400px] flex items-center border-2 border-opacity-15 rounded-md overflow-hidden  transition-transform duration-300 transform hover:scale-105 ${
                  selectedItem === index
                    ? "bg-[#25a244]  text-white hover:text-white border-none"
                    : ""
                }`}
              >
                <p>{item.label}</p>
