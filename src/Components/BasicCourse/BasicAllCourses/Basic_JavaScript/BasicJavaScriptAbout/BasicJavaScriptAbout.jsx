...
const BasicJavaScriptAbout = () => {
  return (
    <div className="mx-auto w-full md:lg:xl:px-10 p-1 bg-gradient-to-br  to-[#ffb703] from-[#fb8500]">
      <div className="pt-0">
      ...
      <div className="py-2">
        <p className="text-6xl font">
          Discover the
          <p className="text-[#480ca8] my-2">JavaScript Program</p>
        </p>
      </div>
...
export default BasicJavaScriptAbout;
