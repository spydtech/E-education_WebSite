        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold">
              Mastering JavaScript: Build Dynamic Web Applications
            </h2>
            <p className="text-lg text-[#480ca8] font-semibold mt-2">
              Enhance your web development skills with our comprehensive
              JavaScript courses. Dive deep into JavaScript programming and gain
              hands-on experience. Whether novice or pro, create dynamic and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-1">
                <img
                  ...
                  alt="Project 1"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r to-[#ffb703] from-[#fb8500] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#480ca8] group-hover:text-white pt-4">
                    Browse our extensive catalog of JavaScript courses. Discover
              ...
              <a href="/project-2">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#480ca8] group-hover:text-white pt-4">
                    ...
                    tools, and methodologies essential for JavaScript
                    development.
                  </span>
                </div>
              </a>
              ...
              <a href="/project-3">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#480ca8] group-hover:text-white pt-4">
                    ...
                    in JavaScript development, DOM manipulation, and web
              ...
              <a href="/project-4">
                ...
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#480ca8] group-hover:text-white pt-4">
                    ...
                    proficiency in various JavaScript concepts as you advance
                    through the courses.
                  </span>
                </div>
              </a>
            ...
            <div className="group portfolio-item relative hover:shadow-lg shadow-md rounded-lg overflow-hidden">
              <a href="/project-5">
                <img
                  className="w-full h-60 object-cover"
                  src="https://img.freepik.com/free-vector/programmer-concept-illustration_114360-2417.jpg?t=st=1716965670~exp=1716969270~hmac=9f2b367e36b06a173db9c0acb787db11fb4844d424f6b803709cd88c6c6f5789&w=740"
                  alt="Project 5"
                />
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-r to-[#ffb703] from-[#fb8500] opacity-0 transition duration-300 ease-in-out group-hover:opacity-70"></div>
                <div className="p-4 flex flex-col items-center justify-between relative z-10">
                  ...
                  <span className="text-sm font-bold text-[#480ca8] group-hover:text-white pt-4">
                    ...
                    deeper into specific areas of JavaScript development, such
                    as frameworks, API integration, or performance optimization.
