...
//   useEffect(() => {
//     localStorage.setItem("filessent", filessent);
//   }, [filessent]);
...
//   const progressBarWidth = `${(completedTasks / files.length) * 100}%`;
...
//   };
//     const progressBarWidth = `${(acceptedFilesCount / totalFiles) * 100}%`;
...
//   const progressBarWidth = `${(acceptedFilesCount / totalFiles) * 100}%`; // Define acceptedFilesCount and totalFiles
