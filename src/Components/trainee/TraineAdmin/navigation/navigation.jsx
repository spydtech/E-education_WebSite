    ...
    <>
      <div className="flex flex-col items-center min-h-screen  ">
        <div className="flex justify-center  w-auto">
          <nav className="flex flex-col sm:flex-row w-full sm:w-auto max-w-full md:max-w-xl    overflow-visible"></nav>
        </div>
        <div
          className={`${
            themes === "dark" && "bg-black"
          }  container mx-auto py-3   rounded-lg`}
        >
          {currentSection === 0 && <ProfileSection />}
          {/* {currentSection === 1 && <TraineForgotPassword />} */}
          {/* {currentSection === 1 && <TraineeUpdatePassword />} */}
          {/* {currentSection === 2 && <Themetoggle />} */}
        </div>
      </div>
    </>
  );
