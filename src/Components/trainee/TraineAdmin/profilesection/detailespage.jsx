...
//       <div className="w-[400px] max-w-lg p-8  rounded-lg shadow-lg">
      ...
      <div className="w-full space-y-4">
        {Object.keys(details).map((key) => (
          <div
            ...
            className="bg-gray-50 rounded-lg overflow-hidden shadow-md"
          >
            <div className="px-4 py-3 flex flex-col md:flex-row items-start md:items-center justify-between">
              ...
              {editMode ? (
                <input
                  ...
                  value={editedDetails[key]}
                  onChange={handleChange}
                  className="text-gray-800 font-medium border-b border-gray-300 outline-none focus:border-blue-500 mt-2 md:mt-0 md:ml-4 px-2 py-1 rounded w-full md:w-auto"
                />
              ) : (
                <span className="text-gray-800 w-full md:w-auto text-right font-medium mt-2 md:mt-0">
                  {details[key]}
                </span>
              )}
            </div>
