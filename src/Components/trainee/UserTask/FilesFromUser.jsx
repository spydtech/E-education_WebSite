  ...
  const handleAction = (index, action) => {
    ...
    if (action === "Accepted") {
      ...
      localStorage.setItem(
        "acceptedFiles",
        JSON.stringify([...acceptedFiles, { ...selectedFile, accepted: true }])
      );
      ...
      localStorage.setItem(
        "rejectedFiles",
        JSON.stringify([...rejectedFiles, { ...selectedFile, rejected: true }])
      );
    }
  };
    ...
    <>
      <div className={` p-4`}>
        <h1 className={`   font-semibold text-2xl`}>
          <p className={`border-b-2 text-[20px] border-[#204349]`}>
            Tasks From Trainee
          </p>
        </h1>
        ...
        <div
          className={`  max-w-full  md:p-1 rounded-lg md:w-[500px] h-[400px] overflow-y-auto scrollbar-hide`}
        >
