  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-1   lg:grid-cols-2 lg:px-8">
        ...
        <div
          className={`bg-white text-black  flex-1  rounded-lg  border-[#204349]  border-2 border-solid shadow-lg`}
        >
          <div className="p-4">
            <h1 className=" font-semibold text-lg mb-4">
              <h1 className={`  border-b-2 border-[#204349] w-28`}>
                Upload Tasks
              </h1>
            </h1>
        ...
        <div
          className={`bg-white text-black   flex-1  rounded-lg  border-[#204349] border-2 border-solid`}
        >
          <FileFromUser />
        </div>
      </div>
