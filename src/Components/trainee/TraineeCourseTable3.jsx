...
function UserCourseTable2() {
  ...
  const userCourses = [
    { username: "ryan", courseName: "JavaScript Essentials" },
    { username: "user2", courseName: "JavaScript Essentials" },
    { username: "user3", courseName: "JavaScript Essentials" },
    { username: "user4", courseName: "JavaScript Essentials" },
    { username: "user5", courseName: "JavaScript Essentials" },
  ];
