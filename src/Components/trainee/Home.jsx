        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
          <div id="4cards" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link to="/traineecourses">
              {" "}
              <div className=" hover:cursor-pointer card1 w-72 h-44 border p-4 bg-white rounded-lg">
...
//   return (
//     <>
//       <div id="container" className="px-2 bg-gray-100 float-end w-[1000px]">
//         <div className="ml-4 md:ml-10">
//           <p className="text-black font-bold pt-4 text-xl">DASHBOARD</p>
//         </div>
//         <div className="w-full grid grid-cols-1 lg:grid-cols-2  p-4">
//           <div
//             id="4cards"
//             className="grid grid-cols-1 w-[600px] sm:grid-cols-2 gap-2"
//           >
...
//           <div
//             id="right-card"
//             className="border w-80 ml-36  bg-white p-4 rounded-lg"
//           >
//             <p className="text-black font-bold">Submissions to Approve</p>
//             <div className="p-4 flex gap-2 flex-wrap">
//               <TfiArrowTopRight className="text-green-600 w-8 h-8" />
