...
//         </div>
//         <div className="w-full h-[400px]  grid grid-cols-2 px-4 py-6">
//           <div
//             id="4cards"
//             className="grid grid-cols-2 justify-center gap-x-24 gap-5 items-center w-[500px]"
//           >
//             <div className="card1 w-72 h-44  border-1 p-4 bg-white rounded-lg">
...
//                 ))}
//               </ul>
//               <div className=" text-xl bg-white font-lora font-bold text-green-600 w-24 h-24 border-4 border-green-400 rounded-full relative bottom-24 left-36 flex items-center justify-center">
//                 {total}
//               </div>
//             </div>
//             <div className="card2 w-72 h-44  bg-white border-1 p-4  rounded-lg">
...
//                 ))}
//               </ul>
//               <div className=" text-xl  bg-white font-lora font-bold text-blue-600 w-24 h-24 border-4 border-blue-600 rounded-full relative bottom-12 left-36 flex items-center justify-center">
//                 {usertotal}
//               </div>
//             </div>
//             <div className="card3 bg-white w-72 h-44 border-1 p-4  rounded-lg">
//               {" "}
...
//               </div>
//             </div>
//             <div className="card4 w-72 h-44  bg-white border-1 p-4   rounded-lg">
//               {" "}
//               <div className="flex justify-between">
//                 {" "}
//                 <p className="text-black font-bold">Sheduled Reports</p>
//                 <Link>
//                   <p className="text-blue-700">
//                     {" "}
//                     <RxDoubleArrowRight className="float-start  w-6 h-6" />
...
//           <div
//             id="right-card"
//             className=" border-1 bg-white w-[600px] h-[370px]  p-4 rounded-lg"
//           >
...
//         <div
//           id="table-card"
//           className=" border-1 bg-white w-full h-auto  p-4 my-4 rounded-lg"
//         >
//           <CourseCompletionTable></CourseCompletionTable>
//         </div>
//       </div>
//     </>
//   );
    ...
    <>
      <div id="container" className="px-2 bg-gray-100">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
          <div id="4cards" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div id="right-card" className="border bg-white p-4 rounded-lg">
            <p className="text-black font-bold">Submissions to Approve</p>
            <div className="p-4 flex gap-2 flex-wrap">
              <TfiArrowTopRight className="text-green-600 w-8 h-8" />
              <p className="font-bold">User Tasks</p>
