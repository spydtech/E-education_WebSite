...
//     <tr key={item.name} className="border-b text-[#FF9B26]">
//       <td className="px-6 py-4 whitespace-nowrap">
//         <div className="flex items-center">
//           <img
//             className="h-10 w-10 rounded-full  text-[#FF9B26]"
//             src={item.avatar}
...
//         <h1 className="text-center text-2xl font-semibold p-4 text-[#FF9B26]">Active Users</h1>
//         <input
//           type="search"
//           value={searchTerm}
//           onChange={handleSearchChange}
//           placeholder="Search by name..."
//           className="w-auto px-3 py-2 mb-3 mx-auto bg-white border border-[#FF9B26]  placeholder:text-[#FF9B26] rounded-md shadow-sm focus:outline-none focus:ring-[#FF9B26] focus:border-[#FF9B26] sm:text-sm"
...
//           <thead className="">
//             <tr>
//               <th className="px-6 py-3 text-left text-xs font-medium text-white bg-[#FF9B26] uppercase tracking-wider">
//                 Employee
//               </th>
//               <th className="px-6 py-3 text-left text-xs font-medium text-white bg-[#FF9B26] uppercase tracking-wider">
//                 Role
...
//             </tr>
//           </thead>
//           <tbody className="bg-white divide-y divide-white-200">{rows}</tbody>
//         </table>
//       </div>
//     </div>
//   );
...
function ActiveUsers({ updateUsersCount }) {
  ...
  return (
    <div className="overflow-x-auto  mt-2 ml-4 mr-4 sm:ml-10 sm:mr-10">
      <div className="min-w-full overflow-hidden rounded-lg">
        <h1 className="text-center text-2xl font-semibold p-4 text-[#FF9B26]">Active Users</h1>
        <div className="flex justify-center mb-4">
          <input
            ...
            onChange={handleSearchChange}
            placeholder="Search by name..."
            className="w-full max-w-xs sm:max-w-md px-3 py-2 bg-white border border-[#FF9B26] placeholder:text-[#FF9B26] rounded-md shadow-sm focus:outline-none focus:ring-[#FF9B26] focus:border-[#FF9B26]"
          />
        </div>
        ...
        <table className="min-w-full divide-y divide-gray-200 overflow-x-scroll">
          <thead className="">
            <tr>
              <th className="px-2 sm:px-6 py-3 text-left text-xs font-medium text-white bg-[#FF9B26] uppercase tracking-wider">
                Employee
              </th>
              <th className="px-2 sm:px-6 py-3 text-left text-xs font-medium text-white bg-[#FF9B26] uppercase tracking-wider">
                Role
