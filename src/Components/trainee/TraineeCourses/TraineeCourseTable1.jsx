...
function TraineeCourseTable1() {
  ...
  const userCourses = [
    { username: "rahul", courseName: "React Basics" },
    { username: "john", courseName: "React Basics" },
    { username: "cyan", courseName: "React Basics" },
    { username: "ben", courseName: "React Basics" },
    { username: "kevin", courseName: "React Basics" },
