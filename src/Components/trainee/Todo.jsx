...
//         <div className="w-[500px] h-auto mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
...
//         </div>
//         {selectedTask && (
//           <div className="w-[500px] mx-auto bg-white shadow-lg rounded-lg overflow-hidden ml-4 p-4">
//             <h2 className="text-gray-800 font-bold text-xl">Task Details</h2>
//             <p className="mt-2">
