...
const UserProfile = () => {
  ...
  return (
    <div>
      <div className="bg-[url('https://placehold.co/1920x300')] bg-cover bg-center py-12">
      ...
      <div className="container mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full border border-border rounded-md shadow-sm p-2 focus:ring-primary focus:border-primary"
        ...
        <div className="mt-6 text-right">
          {isEditing ? (
            <button
              onClick={handleSave}
              className="bg-primary text-primary-foreground hover:bg-primary/80 px-4 py-2 rounded-lg flex items-center"
            >
              <img
                aria-hidden="true"
                alt="save-icon"
