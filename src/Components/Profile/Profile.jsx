...
//                   id="firstName"
//                   name="firstName"
//                   value={editedData.details.firstName}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="lastName"
//                   name="lastName"
//                   value={editedData.details.lastName}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="DateOfBirth"
//                   name="DateOfBirth"
//                   value={editedData.details.DateOfBirth}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="Gender"
//                   name="Gender"
//                   value={editedData.details.Gender}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="Location"
//                   name="Location"
//                   value={editedData.details.Location}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="PhoneNumber"
//                   name="PhoneNumber"
//                   value={editedData.details.PhoneNumber}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="Email"
//                   name="Email"
//                   value={editedData.details.Email}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                   id="Website"
//                   name="Website"
//                   value={editedData.details.Website}
//                   onChange={handleInputChange}
//                   className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
//                 />
//               </div>
...
//                 beneficial to share your educational path. If you have obtained
//                 a college degree, you can exclude your high school or GED
//                 details. Remember, all fields are optional but can greatly
...
//                             Even if you didn’t finish, it’s important to include
//                             it here. And if you’ve earned a college degree, you
//                             don’t need to add your high school/GED. All fields
//                             are optional.
//                           </p>
...
function Profile() {
  ...
  return (
    <div>
      ...
      <section className="w-full p-2 overflow-hidden dark:bg-gray-900">
        <div className="flex flex-col">
        <FaCamera
         className="relative bg-white bg-rounded-full mb-[-5%] ml-2 text-xl"
        onClick={() => document.getElementById('coverImage').click()}  />
         <input type="file" id="coverImage" className="hidden" onChange={handlecoverImageChange} accept="image/*" />
          ...
          <div className="sm:w-[80%] xs:w-[90%] mx-auto flex ">
            <label htmlFor="profile-image-input" className="cursor-pointer">
              <img
                src={userData.profileImage}
                alt="User Profile"
                  className="rounded-md lg:w-[12rem] lg:h-[12rem] md:w-[10rem] md:h-[10rem] sm:w-[8rem] sm:h-[8rem] xs:w-[7rem] xs:h-[7rem] outline outline-2 outline-offset-2 outline-[#fb923c] relative lg:bottom-[5rem] sm:bottom-[4rem] xs:bottom-[3rem]"
                  onClick={() => document.getElementById('profile-image-input').click()}
              />

            </label>
            <input type="file" id="profile-image-input" className="hidden" onChange={handleProfileImageChange} accept="image/*" />
           <div className="h-20 w-full bg-[#164e63] flex">
           <h1 className="w-full  text-left my-4 sm:mx-4 xs:pl-4 text-white dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif">
            ...
            <FaUserEdit onClick={handleEdit} className="text-6xl text-white px-4 py-2 rounded-full" />
           </div>
            
          </div>
          <div className="xl:w-[80%] lg:w-[90%]  md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
            <p className="w-[100%] border-2 shadow-xl p-5 rounded-lg bg-[#164e63] text-white dark:text-white text-md">{userData.details.bio}</p>
            <div className="w-full border-2 shadow-xl p-5 rounded-lg bg-[#164e63] my-auto py-6 flex flex-col justify-center gap-2">
              <div className="w-full flex sm:flex-row xs:flex-col gap-2 justify-center">
                <div className="w-full">
                  <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div className="flex flex-col pb-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">First Name</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.firstName}</dd>
                    </div>
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Last Name</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.lastName}</dd>
                    </div>
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Date Of Birth</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.DateOfBirth}</dd>
                    </div>
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Gender</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.Gender}</dd>
                    </div>
                  </dl>
                </div>
                <div className="w-full">
                  <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div className="flex flex-col pb-3">
                      ...
                      <dd className="text-lg  text-white font-semibold">{userData.details.Location}</dd>
                    </div>
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Phone Number</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.PhoneNumber}</dd>
                    </div>
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Email</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.Email}</dd>
                    </div>
                    <div className="flex flex-col py-3">
                      <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Website</dt>
                      <dd className="text-lg text-white font-semibold">{userData.details.Website}</dd>
                    </div>
                  </dl>
                </div>
              </div>
      ...
      <div className=" p-10 pt-10 md:justify-end  mb-8">
        ...
        <h1 className="text-2xl font-bold text-white  py-4">Education</h1>
        <div class="p-5  bg-[#164e63] border-2 rounded-lg shadow-lg text-gray-500">
          <div class="flex items-center text-white ">
            <div class="">
              <div class="font-bold text-lg py-2 leading-none hover:underline  hover:text-indigo-600 transition duration-500 ease-in-out">
                Credentials
              </div>
              <div className="mb-4">
                Update your educational background to showcase where you are
              ...
              <div className="py-2 gap-5 boder bg-gray-200 flex flex-col md:flex-row p-2">
                <button
                  onClick={openEducationModel}
                  className="px-5  h-16 border-2 bg-[#2e1065] border-rounded border-blue-700"
                >
                  + Add Education
                </button>
                {/* education open */}
                ...
                {/* education close */}
                <p className="font-bold text-black hover:underline hover:text-blue-600 py-2">
                  Browse your Certificate
                </p>
              </div>
            </div>
