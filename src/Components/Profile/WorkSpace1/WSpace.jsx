...
function WSpace() {
  ...
  const ExplorBrowseProject = [
    {
      image: "https://t3.ftcdn.net/jpg/02/88/80/38/360_F_288803822_0CJ8L3gr6w6nGnUeje6pCllCX7s986xz.jpg",
      title: "Data Science",
    ...
    {
      image: "https://t4.ftcdn.net/jpg/02/86/02/67/360_F_286026740_xWkobcEk5g38qrH7cpfeImAnlUUSIrc5.jpg",
      title: "Business",
    ...
    {
      image: "https://t3.ftcdn.net/jpg/06/17/88/90/360_F_617889061_ZO5zsPTfTmxTfcMG8spbnPHf4wfJMGLY.jpg",
    ...
    {
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnxlauEo4V1_Bnb172cQTKE-i1Uc_3nBcf7tuB9MqqHhKgxLftD-g1aFIJi7PqVMJrWpc&usqp=CAU",
      title: "Health",
    ...
    {
      image: "https://videohive.img.customer.envatousercontent.com/files/229501069/Preview_Image_Di.jpg?auto=compress%2Cformat&fit=crop&crop=top&max-h=8000&max-w=590&s=9d60d3dfa35cee5db662c381e886696f",
    ...
    {
      image: "https://ats.org/wp-content/uploads/2020/04/Index-High-Tech-Future-2400x1374.jpg",
  ...
  return (
    <div>
      <Navbar />
      <h1 className="text-2xl font-bold py-10 px-10  text-[#1e3a8a] text-center hover:underline">WorkSpace</h1>
          ...
          <div className="p-5 border bg-white md:w-[500px] md:h-[250px] h-auto w-auto rounded text-gray-500">
            <div className="flex items-center">
              <div>
                      ...
                      <div className="bg-white rounded-lg shadow-lg relative flex flex-col p-8">
                        <div className="grid grid-cols-1 gap-4">
                          {ExplorBrowseProject.map((course, index) => (
                            <div key={index} className="hover:shadow-2xl border h-[150px]">
                              <div className="flex justify-start items-start flex-row gap-8">
                                ...
                                <div className="md:w-[500px] flex justify-center items-start flex-col pt-3 font-semibold text-gray-600 text-sm">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    >
                                      {uploadedFiles[index] ? "Completed" : "Upload file"}
                                    </label>
                                  </div>
                                </div>
                              </div>
                ...
                <h1 className="text-2xl text-[#581c87] font-semibold">Work Progress</h1>
