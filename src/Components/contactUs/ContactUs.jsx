...
const ContactUs = () => {
  ...
  <div className="container mx-auto px-5 py-24">
    <div className="mb-12 flex w-full flex-col text-center">
      ...
      Reach Out & Elevate Your Learning Journey with E-education
      </h1>
    ...
    <div className="mx-auto md:w-2/3 lg:w-1/2">
      <div className="-m-2 flex flex-wrap">
        ...
        <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
          <a className="text-indigo-400"> support@e-education.in</a>
          <p className="text-indigo-400">+91-7396051014</p>
          <p className="my-5 leading-normal">
          Meera complex Plot, No-852, 2nd floor<br />
            Madhapur Hyderabad, Telangana - 500081
          </p>
          <span className="inline-flex">
            <a href=' https://www.facebook.com/profile.php?id=61558814622409' className="text-gray-500">
              <svg
                fill="currentColor"
                strokeLinecap="round"
            ...
            <a href='https://x.com/eeducatione07' className="ml-4 text-gray-500">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <a href="https://www.instagram.com/eeducatione07/" className="ml-4 text-gray-500">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
            ...
            <a  href="https://www.linkedin.com/company/e-edu/" className="ml-4 text-gray-500">
            <svg
      fill="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
              <div className="flex items-start">
                ...
                <div className="ml-6 grow">
                  ...
                  <p className="text-sm text-neutral-500">+91-7396051014</p>
                </div>
              </div>
            </div>
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
