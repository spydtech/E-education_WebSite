  ...
  const courseData = [
    {
      ...
      description:
        "Browse our extensive catalog of Advance PHP courses Discover beginner-friendly to advanced-level programs designed to accommodate learners of all backgrounds.",
    },
    {
      imgSrc: "https://res.cloudinary.com/dfftgkkev/image/upload/v1726579681/image2_xdrrvu.png",
      title: "Enroll in Foundational Courses",
      description:
        "Start with foundational courses covering basic concepts algorithms, and programming languages essential for Advance PHP.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Monitor your progress with intuitive dashboards and tracking tools. Set goals, track milestones, and measure your proficiency in various Advance PHP concepts as you advance through the courses.",
    },
    {
      imgSrc: "https://res.cloudinary.com/dfftgkkev/image/upload/v1726579696/image5_yxs4dr.png",
      title: "Specialize and Advance",
      description:
        "Choose specialized tracks or advanced courses to delve deeper into specific areas of Advance PHP, such as deep learning, natural language processing, or computer vision. Customize your learning path to align with your interests and career goals.",
    },
    {
