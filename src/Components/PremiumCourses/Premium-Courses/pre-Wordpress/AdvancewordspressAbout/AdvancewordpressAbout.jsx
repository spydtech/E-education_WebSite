  ...
  const wordpressAbout = [
    {
      ...
      description:
        "Access student support via support@wordpress.com or through the ask us? option on our learning platform for urgent queries.",
      imgSrc: programmer,
